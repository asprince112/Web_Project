        ...
        try:
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    shipping_post_code = form.cleaned_data.get('shipping_post_code')

                    if is_valid_form([shipping_address, shipping_country, shipping_post_code]):
                ...
                if same_billing_address:
                    ...
                    billing_post_code = form.cleaned_data.get('billing_post_code')

                    if is_valid_form([billing_address, billing_country, billing_post_code]):
